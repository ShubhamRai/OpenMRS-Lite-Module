...
public class InfoAndErrorMessagesFragmentController {
	...
	public void controller(HttpServletRequest request, FragmentModel fragmentModel) {
		...
		String errorMessage = (String) session
		        .getAttribute(OpenmrsLiteWebConstants.SESSION_ATTRIBUTE_ERROR_MESSAGE);
		String infoMessage = (String) session.getAttribute(OpenmrsLiteWebConstants.SESSION_ATTRIBUTE_INFO_MESSAGE);
		session.setAttribute(OpenmrsLiteWebConstants.SESSION_ATTRIBUTE_ERROR_MESSAGE, null);
		session.setAttribute(OpenmrsLiteWebConstants.SESSION_ATTRIBUTE_INFO_MESSAGE, null);
