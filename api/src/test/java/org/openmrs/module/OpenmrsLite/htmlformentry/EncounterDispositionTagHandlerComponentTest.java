package org.openmrs.module.OpenmrsLite.htmlformentry;
...
import org.openmrs.module.OpenmrsLite.OpenmrsLiteActivator;
...
public class EncounterDispositionTagHandlerComponentTest extends BaseModuleContextSensitiveTest {
    ...
    public void setUp() throws Exception {
        ...
        EncounterDispositionTagHandler tagHandler = OpenmrsLiteActivator.setupEncounterDispositionTagHandler(emrApiProperties, dispositionService, adtService, featureToggles);
        Context.getService(HtmlFormEntryService.class).addHandler(OpenmrsLiteConstants.HTMLFORMENTRY_ENCOUNTER_DISPOSITION_TAG_NAME, tagHandler);
        dispositionService.setDispositionConfig("OpenmrsLiteTestDispositionConfig.json");  // we use a custom name so as to not clash with the test one in the emr-api module
    }
