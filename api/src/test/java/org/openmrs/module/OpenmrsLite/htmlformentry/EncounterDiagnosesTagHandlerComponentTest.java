...
public class EncounterDiagnosesTagHandlerComponentTest extends BaseModuleContextSensitiveTest {
    ...
    public void setUp() throws Exception {
        ...
        EncounterDiagnosesTagHandler encounterDiagnosesTagHandler = OpenmrsLiteActivator.setupEncounterDiagnosesTagHandler(conceptService, adtService, Context.getRegisteredComponent("emrApiProperties", EmrApiProperties.class));
        Context.getService(HtmlFormEntryService.class).addHandler(OpenmrsLiteConstants.HTMLFORMENTRY_ENCOUNTER_DIAGNOSES_TAG_NAME, encounterDiagnosesTagHandler);
    }
