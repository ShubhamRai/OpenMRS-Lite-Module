<%
    def fragmentProvider = "OpenmrsLite"
    def placeholder =  ui.message("OpenmrsLite.dataManagement.searchCoded")
    ...
    ui.includeJavascript("OpenmrsLite", "fragments/datamanagement/findDiagnosis.js")
    ui.includeJavascript("OpenmrsLite", "fragments/datamanagement/codeDiagnosisDialog.js")
...
${ ui.includeFragment("OpenmrsLite", "datamanagement/diagnosisAutocompleteTemplate") }

<div id="code-diagnosis-dialog" class="dialog-diagnoses" style="display: none">
    <div class="dialog-header">
        <h3>${ ui.message("OpenmrsLite.dataManagement.codeDiagnosis.title") }</h3>
    </div>
    ...
    <div class="dialog-content">
        <form id="consult-note" method="post">
            ...
            <button id="confirmCodedDiagnosisId" class="confirm right" data-bind="css: { disabled: !canSubmit() }, enable: canSubmit()">${ui.message("OpenmrsLite.confirm")}</button>
