...
function createEditPatientIdentifierDialog(patientId) {
    editPatientIdentifierDialog = emr.setupConfirmationDialog({
        ...
        actions: {
            confirm: function() {
                emr.getFragmentActionWithCallback('OpenmrsLite', 'editPatientIdentifier', 'editPatientIdentifier'
                    , { patientId: patientId,
    ...
    deleteEncounterDialog = emr.setupConfirmationDialog({
        ...
        actions: {
            confirm: function() {
                ...
                emr.getFragmentActionWithCallback('OpenmrsLite', 'visit/visitDetails', 'deleteEncounter'
...
function createDeleteVisitDialog(visitId, patientId) {
    deleteVisitDialog = emr.setupConfirmationDialog({
        ...
        actions: {
            confirm: function() {
                emr.getFragmentActionWithCallback('OpenmrsLite', 'visit/visitDetails', 'deleteVisit'
                    , { visitId: visitId}
                    , function(data) {
