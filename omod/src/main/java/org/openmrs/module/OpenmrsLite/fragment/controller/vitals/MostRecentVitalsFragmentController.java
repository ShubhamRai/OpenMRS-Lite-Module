 ...
 */
package org.openmrs.module.OpenmrsLite.fragment.controller.vitals;
...
public class MostRecentVitalsFragmentController {
	...
	public void controller(FragmentModel model, @FragmentParam("patientId") Patient patient,
		...
		encounterTypes.add(encounterService.getEncounterTypeByUuid(OpenmrsLiteConstants.VITALS_ENCOUNTER_TYPE_UUID));
