...
import org.openmrs.module.OpenmrsLite.RegistrationAppUiUtils;
import org.openmrs.module.OpenmrsLite.form.RegisterPatientFormBuilder;
import org.openmrs.module.OpenmrsLite.model.NavigableFormStructure;
...
public class RegisterPatientPageController {
    ...
    private static final String REGISTRATION_SECTION_EXTENSION_POINT = "org.openmrs.module.OpenmrsLite.section";
    ...
    public String post(UiSessionContext sessionContext, PageModel model, @RequestParam("appId") AppDescriptor app,
        ...
        InfoErrorMessageUtil.flashInfoMessage(request.getSession(), ui.message("OpenmrsLite.createdPatientMessage", patient.getPersonName()));
