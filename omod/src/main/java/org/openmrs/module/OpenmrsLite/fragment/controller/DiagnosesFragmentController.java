        ...
        if(nonCodedObsId != null){
            ...
            if (nonCodedObs !=null ){
                ...
                if ((newDiagnoses != null) && (newDiagnoses.size()>0) ){
                    return new SuccessResult(ui.message("OpenmrsLite.dataManagement.codeDiagnosis.success"));
                }
            }
        }
        return new FailureResult(ui.message("OpenmrsLite.dataManagement.codeDiagnosis.failure"));
    }
