...
public class ParserEncounterIntoSimpleObjectsTest {
	...
	public void testParsingDiagnoses() throws Exception {
		...
		assertThat(path(parsed.getDiagnoses(), 0, "question"), is((Object) "OpenmrsLite.patientDashBoard.diagnosisQuestion.PRIMARY"));
		assertThat(path(parsed.getDiagnoses(), 0, "answer"),
		    is((Object) "(OpenmrsLite.Diagnosis.Certainty.PRESUMED) Random Disease"));
